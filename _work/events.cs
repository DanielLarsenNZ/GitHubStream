...
namespace QuickType
{
    ...
    public partial class Commits
    {
        public static Commits[] FromJson(string json) => JsonConvert.DeserializeObject<Commits[]>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Commits[] self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
